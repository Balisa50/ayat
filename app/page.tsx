...
export default function Home() {
 ...
 {/*
 Search bar, kept mounted across card open/close so the user's
 Ask-mode draft and chosen mode (Theme vs Ask) survive when they
 peek at a verse and come back. Visibility is handled by the CSS
 rule on `html[data-card-open="1"]` in globals.css. Unmounting via
 a `!selected` gate would destroy the SearchBar's internal state
